...
public class Praktikum {
    public static void main(String[] args) {
        Hamster[] hamsters = new Hamster[]{
                ...
                new Hamster("Ниндзя",168.0,3,"Рыже-белый",true,false) // Добавьте Ниндзю
        };
        ...
        for (int i = 0; i < hamsters.length; i++) {
            ...
            boolean isColor = hamster.color.equals("Рыжий") || hamster.color.equals("Белый")&& hamster.isFluffy;
