...
public class Praktikum {
    public static void main(String[] args) {
        ...
        float pixelChoice = getMinKcalsSum(beefKcal, chickenKcal, creamKcal, milkKcal);// то что сьел кот
        float totalKcal = Integer.parseInt(pixelKcalDay) + pixelChoice;// распарсиваем калории + всего калорий
        checkKcal(totalKcal);// вызываем метод по проверке суточного потребления калорий
    }
