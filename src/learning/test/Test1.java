...
public class Test1 {
    public static void main(String[] args) {
        ...
        boolean directTicketsCheaper = (ticketMoscowLondonParis < ticketMoscowParis && hasBritainVisa); // Сравнение стоимости билетов, прямые билеты дешевле


        if (directTicketsCheaper) { // Проверить в одном условии наличие дешёвых билетов и визы
